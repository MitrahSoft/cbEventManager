...
<div class="row-fluid">
	<div class="span9" id="main-content">
		...
		<div class="box">
			...
			<div class="body">
				#html.startForm(action="cbadmin.module.Calendar.tag.index",name="searchPage",id="searchPage",method="post")#
					<div class="well well-small" id="contentBar">
						
						#getPlugin("MessageBox").renderit()#
						
						<div class="buttonBar">
							<a class="btn btn-danger" href="#event.buildLink(prc.xehmodule)#/tag/addEdit">Create Tag</a>
						</div>
				...
				#html.endForm()#
				<table class="table tablesorter table-hover" name="tagForms" id="tagForms">
					<thead>
						<tr>
							<th>Name</th>
							<th>Slug</th>
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu text-left pull-right">
											<li><a href="#event.buildLink(prc.xehmodule)#/tag/addEdit?term_id=#term_id#"><i class="icon-edit icon-large"></i> Edit</a></li>
		...
		<div class="small_box" id="help_tips">
			...
			<div class="body">
				<ul class="tipList unstyled">
					<li><i class="icon-lightbulb icon-larg"></i> Tag will group the Events in accordance with theme</li>
					...
					<li><i class="icon-lightbulb icon-larg"></i> Create Tag is Only used for add new Tag</li>
				</ul>
			</div>
		</div>
	</div>
...
<script>
	$(document).ready(function() {
		$("#pageSearch").keyup(function(){
			...
			$.uiTableFilter( $("#tagForms"), this.value);
		})
	});
</script>